...
class RegistrationViewController: UIViewController {
    ...
    // Botón de CREAR (azul claro)
    private let createButton: UIButton = {
        let button = UIButton(type: .system)
        button.setTitle("Crear", for: .normal)
        button.setTitleColor(.black, for: .normal)
        button.backgroundColor = UIColor(red: 173/255, green: 216/255, blue: 230/255, alpha: 1.0) // Azul claro (Light Blue)
    ...
    // MARK: - Funciones de Fábrica (Helpers)
    ...
    @objc private func handleCreate() {
        ...
        // Simplemente volvemos a la pantalla de Login después de un intento de creación
